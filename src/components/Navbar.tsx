...
import { LayoutDashboard, Settings, FileText, Sun, Moon, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function Navbar({ currentView, setCurrentView }: NavbarProps) {
  ...
  return (
    <nav className={`${isCollapsed ? 'w-20' : 'w-64'} bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 h-screen flex flex-col transition-all duration-300`}>
