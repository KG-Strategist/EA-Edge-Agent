...
const SovereignTensorCoreFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sovereigntensorcore_free(ptr >>> 0, 1));
...
export class SovereignTensorCore {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SovereignTensorCoreFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sovereigntensorcore_free(ptr, 0);
    }
    /**
     * @returns {Promise<boolean>}
     */
    init_webgpu() {
        const ret = wasm.sovereigntensorcore_init_webgpu(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    upload_to_vram() {
        const ret = wasm.sovereigntensorcore_upload_to_vram(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {string} prompt
     ...
     */
    begin_prefill_async(prompt) {
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sovereigntensorcore_begin_prefill_async(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} prompt
     * @param {number} _random_seed
     * @returns {Promise<number>}
     */
    prefill_prompt_async(prompt, _random_seed) {
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sovereigntensorcore_prefill_prompt_async(this.__wbg_ptr, ptr0, len0, _random_seed);
        return ret;
    }
    /**
     * @param {number} _token
     ...
     * @returns {Promise<number>}
     */
    decode_next_token_async(_token, _pos, _random_seed) {
        const ret = wasm.sovereigntensorcore_decode_next_token_async(this.__wbg_ptr, _token, _pos, _random_seed);
        return ret;
    }
    /**
     ...
     * @returns {Promise<number>}
     */
    prefill_next_chunk_async(max_steps) {
        const ret = wasm.sovereigntensorcore_prefill_next_chunk_async(this.__wbg_ptr, max_steps);
        return ret;
    }
    /**
     * @returns {Promise<number>}
     */
    generate_next_token_async() {
        const ret = wasm.sovereigntensorcore_generate_next_token_async(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    get_eos_id() {
        const ret = wasm.sovereigntensorcore_get_eos_id(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {string} prompt
     * @returns {number}
     */
    begin_prefill(prompt) {
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sovereigntensorcore_begin_prefill(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    clear_kv_cache() {
        wasm.sovereigntensorcore_clear_kv_cache(this.__wbg_ptr);
    }
    /**
     * @returns {number}
     */
    get_vocab_size() {
        const ret = wasm.sovereigntensorcore_get_vocab_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {string} prompt
    ...
    prefill_prompt(prompt) {
        const ptr0 = passStringToWasm0(prompt, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sovereigntensorcore_prefill_prompt(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    get_architecture() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sovereigntensorcore_get_architecture(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    is_hybrid_active() {
        const ret = wasm.sovereigntensorcore_is_hybrid_active(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_vram_uploaded() {
        const ret = wasm.sovereigntensorcore_is_vram_uploaded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {string}
    ...
    get_chat_template() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sovereigntensorcore_get_chat_template(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {number}
     */
    prefill_next_chunk(max_steps) {
        const ret = wasm.sovereigntensorcore_prefill_next_chunk(this.__wbg_ptr, max_steps);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     * @returns {string}
     */
    decode_single_token(token_id) {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.sovereigntensorcore_decode_single_token(this.__wbg_ptr, token_id);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    free_weights_buffer() {
        wasm.sovereigntensorcore_free_weights_buffer(this.__wbg_ptr);
    }
    /**
     * @returns {number}
     */
    generate_next_token() {
        const ret = wasm.sovereigntensorcore_generate_next_token(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
    ...
    get_tokenizer_model() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.sovereigntensorcore_get_tokenizer_model(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    is_prefill_complete() {
        const ret = wasm.sovereigntensorcore_is_prefill_complete(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    get_vram_shard_count() {
        const ret = wasm.sovereigntensorcore_get_vram_shard_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {string}
     */
    get_vram_upload_status() {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.sovereigntensorcore_get_vram_upload_status(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    reset_generation_state() {
        wasm.sovereigntensorcore_reset_generation_state(this.__wbg_ptr);
    }
    /**
     * @param {number} size
     * @returns {number}
     */
    allocate_weights_buffer(size) {
        const ret = wasm.sovereigntensorcore_allocate_weights_buffer(this.__wbg_ptr, size);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     */
    compute_epistemic_state(base_t, lambda) {
        const ret = wasm.sovereigntensorcore_compute_epistemic_state(this.__wbg_ptr, base_t, lambda);
        if (ret[3]) {
     ...
     * @returns {number}
     */
    get_vram_uploaded_bytes() {
        const ret = wasm.sovereigntensorcore_get_vram_uploaded_bytes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {boolean}
    ...
    initialize_tensor_graph() {
        const ret = wasm.sovereigntensorcore_initialize_tensor_graph(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     * @returns {number}
     */
    get_vram_max_shard_bytes() {
        const ret = wasm.sovereigntensorcore_get_vram_max_shard_bytes(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {string}
     */
    get_hardware_block_reason() {
        let deferred1_0;
        let deferred1_1;
        try {
            const ret = wasm.sovereigntensorcore_get_hardware_block_reason(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor() {
        const ret = wasm.sovereigntensorcore_new();
        this.__wbg_ptr = ret >>> 0;
        SovereignTensorCoreFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {boolean}
     */
    is_loaded() {
        const ret = wasm.sovereigntensorcore_is_loaded(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('eaniti_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
