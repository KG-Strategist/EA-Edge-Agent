...
export default function AdminPanel() {
  ...
  return (
    <div className="max-w-6xl mx-auto h-full flex flex-col">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 flex-1 flex flex-col overflow-hidden shadow-sm dark:shadow-none">
        <div className="border-b border-gray-200 dark:border-gray-700 px-6 pt-4 flex gap-6 overflow-x-auto">
          {tabs.map((tab) => (
            <button
              key={tab.id}
