  ...
  return (
    <div className="w-full flex-1 flex flex-col min-h-0">
      <div className="flex justify-between items-center mb-6 shrink-0">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Architecture Reviews</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Manage and track local architecture assessment scopes.</p>
        </div>
        <button 
