...
> Generated: 2026-08-11 00:52:06 | Branch: nightly | Commit: 17
> Do not edit by hand. Regenerate with: node .opencode/harness/repo-memory.mjs

## Current State
- **Version:** 1.1.4-beta
- **Branch:** nightly
- **Last commit:** 35725c7 docs: update RELEASE_NOTES with v1.1.4-beta build fix and OCR model evaluation findings
- **Total commits:** 17
- **Node engine:** >=20.0.0 <23.0.0
- **Dirty tree:** 6 modified, 6 untracked
...
- **TSD specs available:** 112 files in docs-internal/tsd

## Git Ignore Status
- [OK] .gitignore
- AGENTS.md whitelisted: YES
- /artifacts/ rule present: YES (renamed to /ml-outputs/)
...
## Package Scripts
- build:wasm, build:wasm:ocr, build:lexicon, build:corpus, build:training-corpus, build:brain-kb, validate:corpus, verify:corpus, verify:ocr, fetch:corpus, unpack:corpus, pack:corpus, setup:local, predev, dev, prebuild, build, lint, preview, test, test:a11y, test:e2e:sovereign, test:e2e:sovereign-smoke, pretest:e2e:sovereign-gguf, test:e2e:sovereign-gguf, pretest:e2e:sovereign-gguf:headed, test:e2e:sovereign-gguf:headed, pretest:e2e:sovereign-gguf:chrome, test:e2e:sovereign-gguf:chrome, test:watch, test:coverage, cleanup:test-files, harness:gate, harness:gate:release, harness:memory, harness:loop
